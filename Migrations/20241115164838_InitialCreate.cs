        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_BannerSettings_Banners_BannerId",
                        column: x => x.BannerId,
                        principalTable: "Banners",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_BannerSettings_Settings_SettingId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ShippingMethods_Users_CreatedBy",
                        column: x => x.CreatedBy,
                        principalTable: "Users",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_ShippingMethods_Users_UpdatedBy",
                        column: x => x.UpdatedBy,
                        principalTable: "Users",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_InventoryHistory_ProductVariants_ProductVariantId",
                        column: x => x.ProductVariantId,
                        principalTable: "ProductVariants",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_InventoryHistory_Users_CreatedBy",
                        column: x => x.CreatedBy,
                        principalTable: "Users",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_InventoryHistory_Users_UserId",
                        column: x => x.UserId,
                        principalTable: "Users",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_BannerSettings_BannerId",
                table: "BannerSettings",
                column: "BannerId");

            migrationBuilder.CreateIndex(
                name: "IX_BannerSettings_SettingId",
                table: "BannerSettings",
                column: "SettingId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_InventoryHistory_CreatedBy",
                table: "InventoryHistory",
                column: "CreatedBy");

            migrationBuilder.CreateIndex(
                name: "IX_InventoryHistory_ProductVariantId",
                table: "InventoryHistory",
                column: "ProductVariantId");

            migrationBuilder.CreateIndex(
                name: "IX_InventoryHistory_UserId",
                table: "InventoryHistory",
                column: "UserId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ShippingMethods_CreatedBy",
                table: "ShippingMethods",
                column: "CreatedBy");

            migrationBuilder.CreateIndex(
                name: "IX_ShippingMethods_UpdatedBy",
                table: "ShippingMethods",
                column: "UpdatedBy");
